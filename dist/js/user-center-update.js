...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"user-info\"> <div class=\"form-line\"> <span class=\"label\">用户名:</span> <span class=\"text\">{{username}}</span> </div> <div class=\"form-line\"> <span class=\"label\">电 话:</span> <input type=\"text\" id=\"phone\" class=\"input\" autocomplete=\"off\" value=\"{{phone}}\"> </div> <div class=\"form-line\"> <span class=\"label\">邮 箱:</span> <input type=\"text\" id=\"email\" class=\"input\" autocomplete=\"off\" value=\"{{email}}\"> </div> <div class=\"form-line\"> <span class=\"label\">问 题:</span> <input type=\"text\" id=\"question\" class=\"input\" autocomplete=\"off\" value=\"{{question}}\"> </div> <div class=\"form-line\"> <span class=\"label\">答 案:</span> <input type=\"text\" id=\"answer\" class=\"input\" autocomplete=\"off\" value=\"{{answer}}\"> </div> <span class=\"btn btn-submit\">提交</span> </div>";
